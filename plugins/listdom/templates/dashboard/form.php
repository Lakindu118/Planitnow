...
<div class="lsd-dashboard lsd-dashboard-form" id="lsd_dashboard">
    ...
    <div class="lsd-row">
        ...
        <div class="lsd-col-9">
            ...
            <div class="lsd-util-hide" id="lsd_dashboard_form_message"></div>
                ...
                <div class="lsd-row">
                    ...
                    <div class="lsd-col-4">
                        ...
                        <div class="lsd-dashboard-box lsd-dashboard-category">
                            <h4><?php esc_html_e('Category', 'listdom'); ?><?php $this->required_html('listing_category'); ?></h4>
                            <div>
                                <?php
                        ...
                        <?php if($this->is_enabled('image') && current_user_can('upload_files')): ?>
