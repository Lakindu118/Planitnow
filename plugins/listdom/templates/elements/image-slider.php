...
<div class="lsd-image-slider-wrapper <?php echo (count($gallery) ? 'lsd-has-image' : ''); ?>">
    ...
    <ul class="lsd-image-slider-slider">
        ...
        <li>
            ...
            <a data-listing-id="<?php echo esc_attr($post_id); ?>" href="<?php echo esc_url(get_the_permalink($post_id)); ?>" <?php echo ($listing_link_method === 'blank' ? 'target="_blank"' : ''); ?> <?php echo lsd_schema()->url()->scope()->type('https://schema.org/ImageObject'); ?>>
