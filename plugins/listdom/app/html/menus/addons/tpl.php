...
<div class="wrap about-wrap lsd-wrap">
    ...
    <div class="lsd-addons">
        <div class="lsd-row">
            ...
            ?>
            <div class="lsd-col-6 <?php echo trim($classes); ?>">
				<div class="lsd-addon">
					...
					<?php if(!$installed): ?>
						<a class="button" href="<?php echo esc_url($addon->url); ?>" target="_blank"><?php esc_html_e('Details & Buy'); ?></a>
						
						<?php echo ($recommended ? '<div class="lsd-addons-recommended-badge">'.esc_html__('Recommended', 'listdom').'</div>' : ''); ?>
					<?php else: ?>
						<a class="button" href="<?php echo esc_url($addon->documentation); ?>" target="_blank"><?php esc_html_e('Documentation'); ?></a>
					<?php endif; ?>
					</div>
