...
<div class="lsd-settings-wrap">
    <form id="lsd_settings_form">
            ...
            <div class="lsd-map-provider-dependency lsd-map-provider-dependency-googlemap">
                <div class="lsd-form-row">
                    ...
                    <div class="lsd-col-10">
                        ...
                        <p class="description"><?php esc_html_e("Google API Key is mandatory otherwise Google Maps doesn't work. You can get an API key from Google.", 'listdom'); ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="lsd-settings-form-group lsd-accordion-panel">
            ...
            <?php if($this->isLite()): ?>
            <div class="lsd-mb-4"><?php echo LSD_Base::alert($this->missFeatureMessage(esc_html__('Frontend Submission', 'listdom')), 'warning'); ?></div>
            <?php endif; ?>
