...
<div class="lsd-metabox lsd-metabox-filter-options">
    <p class="description lsd-m-4"><?php esc_html_e('Use the following options to filter the listings that you want to display ...', 'listdom'); ?></p>
    ...
    <div class="lsd-accordion-panel">
        <div class="lsd-form-row">
            <div class="lsd-col-12">
                ...
                <p class="description lsd-mb-0"><?php esc_html_e('Insert your desired tags separated by comma.', 'listdom'); ?></p>
            </div>
        </div>
    </div>
    <div class="lsd-accordion-title">
