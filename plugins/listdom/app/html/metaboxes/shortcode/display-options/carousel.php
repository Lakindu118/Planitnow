...
<div class="lsd-form-row">
    ...
    <div class="lsd-col-10">
        <p class="description"><?php echo sprintf(esc_html__('Using %s skin, you can show a carousel of listings with different styles.', 'listdom'), '<strong>'.esc_html__('Carousel', 'listdom').'</strong>'); ?></p>
    </div>
</div>
<div class="lsd-form-row">
