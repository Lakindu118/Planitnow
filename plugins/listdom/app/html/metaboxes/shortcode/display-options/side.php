...
<div class="lsd-form-row">
    ...
    <div class="lsd-col-10">
        <p class="description"><?php echo sprintf(esc_html__('Using the %s skin allows you to display listings on one side and the details page on the other side.', 'listdom'), '<strong>'.esc_html__('Side by Side', 'listdom').'</strong>'); ?></p>
    </div>
</div>
<?php if($this->isLite()): ?>
