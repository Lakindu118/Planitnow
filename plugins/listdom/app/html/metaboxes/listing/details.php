...
<div class="lsd-metabox">
    ...
    <?php if(current_user_can('edit_others_posts') and isset($post->post_status) and $post->post_status == 'pending' and trim($guest_email)): ?>
    ...
    <?php if((!$dashboard || $dashboard->is_enabled('gallery')) && current_user_can('upload_files')): ?>
                    ...
                    <li data-id="<?php echo esc_attr($i); ?>" id="lsd_listing_embeds_<?php echo esc_attr($i); ?>">
                        <div class="lsd-row">
                            <div class="lsd-embeds-fields lsd-col-11">
                                ...
                                <textarea name="lsd[_embeds][<?php echo esc_attr($i); ?>][code]" title="<?php esc_attr_e('Code', 'listdom'); ?>" placeholder="<?php esc_attr_e('Code', 'listdom'); ?>"><?php echo (isset($embed['code']) ? esc_textarea(stripslashes($embed['code'])) : ''); ?></textarea>
                            </div>
            ...
            <li data-id=":i:" id="lsd_listing_embeds_:i:">
                <div class="lsd-row">
                    <div class="lsd-embeds-fields lsd-col-11">
                        ...
                        <textarea name="lsd[_embeds][:i:][code]" title="<?php esc_attr_e('Code', 'listdom'); ?>" placeholder="<?php esc_attr_e('Code', 'listdom'); ?>"></textarea>
                    </div>
                    <div class="lsd-embeds-actions lsd-col-1"><i class="lsd-icon fas fa-trash-alt lsd-remove-embed-single-button"></i> <i class="lsd-icon fas fa-arrows-alt lsd-handler"></i></div>
                </div>
            </li>
