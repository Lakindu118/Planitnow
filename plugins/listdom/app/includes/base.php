...
class LSD_Base
{
    ...
    {
        if($multiple) return sprintf(esc_html__('%s are included in the pro add-on. You can upgrade to the %s now to enjoy all features of listdom!', 'listdom'), ($feature ? '<strong>'.esc_html($feature).'</strong>' : esc_html__('This feature', 'listdom')), '<a href="'.LSD_Base::getUpgradeURL().'" target="_blank"><strong>'.esc_html__('Pro Add-on', 'listdom').'</strong></a>');
        else return sprintf(esc_html__('%s is included in the pro add-on. You can upgrade to the %s now to enjoy all features of listdom!', 'listdom'), ($feature ? '<strong>'.esc_html($feature).'</strong>' : esc_html__('This feature', 'listdom')), '<a href="'.LSD_Base::getUpgradeURL().'" target="_blank"><strong>'.esc_html__('Pro Add-on', 'listdom').'</strong></a>');
    }
