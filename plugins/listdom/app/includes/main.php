...
class LSD_Main extends LSD_Base
{
    ...
    public static function get_name_parts($fullname)
    {
    ...
    public function is_geo_request()
    {
     ...
     * @return int|null
     */
    public static function get_post_id_by_meta($key, $value)
    {
        $db = new LSD_db();
