...
class LSD_API_Controllers_Map extends LSD_API_Controller
{
    ...
    public function search(WP_REST_Request $request)
    {
        ...
        // Fetch the listings
        $listings = $skin->search(array(
            'posts_per_page' => ((isset($vars['maplimit']) and $vars['maplimit'] > 0) ? $vars['maplimit'] : 300)
        ));
        ...
        // Map Controls
        $vars['mapcontrols'] = array_merge(LSD_Options::defaults('mapcontrols'), array('draw' => '0'));
