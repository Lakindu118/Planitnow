    ...
    public static function grab()
    {
            ...
            $form['tags'] = array(
                ...
                'fields' => array(
                    'tags' => array(
                        ...
                        'values' => LSD_API_Resources_Taxonomy::collection($taxonomies->hierarchy(LSD_Base::TAX_TAG)),
                        'required' => false,
                    ),
                )
            );
        ...
        if(self::is_enabled('attributes') and $resource->isPro())
        {
            ...
            foreach($terms as $term)
            {
                ...
                if($all_categories or !is_array($categories)) $categories = [];
        ...
        if(isset($settings['submission_guest']) and $settings['submission_guest'])
        {
            ...
            {
                $guest_fields['guest_fullname'] = array(
                    'key' => 'guest_fullname',
                    'method' => 'text-input',
            ...
            {
                $guest_fields['guest_password'] = array(
                    'key' => 'guest_password',
