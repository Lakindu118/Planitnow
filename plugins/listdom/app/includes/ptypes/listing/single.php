...
class LSD_PTypes_Listing_Single extends LSD_PTypes_Listing
{
    ...
    public function hooks()
    {
        ...
        add_filter('lsd_ptype_listing_supports', array($this, 'add_comments_support'));
    ...
    public function unhook()
    {
        ...
        remove_filter('lsd_ptype_listing_supports', array($this, 'add_comments_support'));
        remove_filter('template_include', array($this, 'template'));
	}
    ...
    {
        $comments = (isset($this->details_page_options['general']) and isset($this->details_page_options['general']['comments']) and $this->details_page_options['general']['comments']);
    ...
    public function remark()
    {
		...
		$schema = lsd_schema()->scope()->type('https://schema.org/UserComments', null);
