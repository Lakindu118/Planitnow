...
class LSD_Dashboard_Terms extends LSD_Base
{
    ...
    public static function locations($args)
    {
        ...
        {
            $args['multiple'] = true;
            $args['selected'] = isset($args['post_id']) ? wp_get_post_terms($args['post_id'], $args['taxonomy'], array('fields' => 'ids')) : [];
    ...
    public static function checkboxes($args, $selected = null)
    {
        $a = $args;
        ...
        // Current Values
        if(is_null($selected)) $selected = isset($args['post_id']) ? wp_get_post_terms($args['post_id'], $args['taxonomy'], array('fields' => 'ids')) : [];
