...
class LSD_Menus extends LSD_Base
{
    ...
    public function register_menus()
    {
        ...
        add_menu_page(esc_html__('Listdom', 'listdom'), esc_html__('Listdom', 'listdom'), 'manage_options', 'listdom', [$this->dashboard, 'output'], $icon, 26);
        ...
        add_submenu_page('listdom', esc_html__('Documentation', 'listdom'), esc_html__('Documentation', 'listdom'), 'manage_options', 'https://webilia.com/docs/doc-category/listdom/', null, 30);
        add_submenu_page('listdom', esc_html__('Support', 'listdom'), esc_html__('Support', 'listdom'), 'manage_options', 'https://webilia.com/support/', null, 31);
    }
